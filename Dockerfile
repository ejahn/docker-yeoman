...
RUN sudo npm install -g grunt-cli bower gulpjs/gulp-cli yo typings generator-karma generator-angular generator-webapp generator-fountain-webapp foundation-cli
